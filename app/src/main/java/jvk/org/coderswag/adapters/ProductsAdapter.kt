...
class ProductsAdapter(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): ProductHolder {
        ...
        return ProductHolder(view, this.itemClick)
    }
    ...
    inner class ProductHolder(itemView: View?, private val itemClick: (Product) -> Unit) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindProduct(product: Product, context: Context) {
            ...
            itemView.setOnClickListener { this.itemClick(product) }
        }
    }
}
